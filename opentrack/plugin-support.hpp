...
struct dylib {
    ...
    {
        const char* filters_n[] = { OPENTRACK_SOLIB_PREFIX "opentrack-proto-*." OPENTRACK_SOLIB_EXT };
...
struct Modules {
    Modules() :
        module_list(dylib::enum_libraries(QCoreApplication::applicationDirPath() + QStringLiteral(OPENTRACK_LIBRARY_PATH))),
